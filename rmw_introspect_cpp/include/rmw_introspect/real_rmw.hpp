...
public:
  ...
  rmw_ret_t (*get_serialized_message_size)(const void*,
  ...
  rmw_ret_t (*service_request_subscription_get_actual_qos)(const rmw_service_t*,
                                                           rmw_qos_profile_t*);
  ...
  // Event handling
  rmw_ret_t (*publisher_event_init)(rmw_event_t*, const rmw_publisher_t*, rmw_event_type_t);
  rmw_ret_t (*subscription_event_init)(rmw_event_t*, const rmw_subscription_t*, rmw_event_type_t);
