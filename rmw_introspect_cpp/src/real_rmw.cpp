...
bool RealRMW::load(const char* implementation_name) {
  ...
  if (verbose) {
    RCUTILS_LOG_INFO_NAMED("rmw_introspect", "Attempting to load %s", lib_name.c_str());
  }
  ...
  // Core
  success &= load_symbol(get_implementation_identifier, "rmw_get_implementation_identifier");
  success &= load_symbol(get_serialization_format, "rmw_get_serialization_format");
  ...
  success &= load_symbol(node_get_graph_guard_condition, "rmw_node_get_graph_guard_condition");
  ...
  success &= load_symbol(publish_serialized_message, "rmw_publish_serialized_message");
  success &= load_symbol(publisher_get_actual_qos, "rmw_publisher_get_actual_qos");
  success &= load_symbol(publisher_count_matched_subscriptions, "rmw_publisher_count_matched_subscriptions");
  success &= load_symbol(publisher_assert_liveliness, "rmw_publisher_assert_liveliness");
  success &= load_symbol(publisher_wait_for_all_acked, "rmw_publisher_wait_for_all_acked");
  ...
  success &= load_symbol(take_serialized_message, "rmw_take_serialized_message");
  success &= load_symbol(take_serialized_message_with_info, "rmw_take_serialized_message_with_info");
  success &= load_symbol(subscription_get_actual_qos, "rmw_subscription_get_actual_qos");
  success &= load_symbol(subscription_count_matched_publishers, "rmw_subscription_count_matched_publishers");
  ...
  success &= load_symbol(destroy_guard_condition, "rmw_destroy_guard_condition");
  success &= load_symbol(trigger_guard_condition, "rmw_trigger_guard_condition");
  ...
  success &= load_symbol(get_node_names_with_enclaves, "rmw_get_node_names_with_enclaves");
  ...
  success &= load_symbol(get_serialized_message_size, "rmw_get_serialized_message_size");

  // Topic and service names/types
  success &= load_symbol(get_topic_names_and_types, "rmw_get_topic_names_and_types");
  success &= load_symbol(get_service_names_and_types, "rmw_get_service_names_and_types");
  success &= load_symbol(get_publisher_names_and_types_by_node, "rmw_get_publisher_names_and_types_by_node");
  success &= load_symbol(get_subscriber_names_and_types_by_node, "rmw_get_subscriber_names_and_types_by_node");
  success &= load_symbol(get_service_names_and_types_by_node, "rmw_get_service_names_and_types_by_node");
  success &= load_symbol(get_client_names_and_types_by_node, "rmw_get_client_names_and_types_by_node");

  // QoS queries for service/client
  success &= load_symbol(service_request_subscription_get_actual_qos, "rmw_service_request_subscription_get_actual_qos");
  success &= load_symbol(service_response_publisher_get_actual_qos, "rmw_service_response_publisher_get_actual_qos");
  success &= load_symbol(client_request_publisher_get_actual_qos, "rmw_client_request_publisher_get_actual_qos");
  success &= load_symbol(client_response_subscription_get_actual_qos, "rmw_client_response_subscription_get_actual_qos");

  // Event handling
  success &= load_symbol(publisher_event_init, "rmw_publisher_event_init");
  success &= load_symbol(subscription_event_init, "rmw_subscription_event_init");
  success &= load_symbol(take_event, "rmw_take_event");
  success &= load_symbol(event_fini, "rmw_event_fini");

  if (!success) {
    if (verbose) {
      RCUTILS_LOG_ERROR_NAMED("rmw_introspect", "Failed to load all symbols from %s", lib_name.c_str());
    }
    unload();
    return false;
  }
  ...
  if (verbose) {
    RCUTILS_LOG_INFO_NAMED("rmw_introspect", "Successfully loaded %s", lib_name.c_str());
  }
...
bool RealRMW::load_symbol(FuncPtr& func_ptr, const char* symbol_name, bool required) {
